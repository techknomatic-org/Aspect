...
import { Target, TrendingUp, Zap, ArrowRight, Award, CheckCircle } from 'lucide-react';
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mt-4 text-xs">
                ...
                <div className="p-3 rounded-xl bg-[#0A1021] border border-slate-800">
                  ...
                  <span className="text-base font-extrabold text-teal-300 mt-0.5 block">{opp.growth}</span>
                </div>
              </div>
            </div>

            <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-xs">
              <span className="text-slate-400">Confidence: <strong>{opp.confidence}</strong></span>
