      ...
      <div className="relative w-12 h-12 flex items-center justify-center shrink-0">
        ...
        <div
          className={`absolute inset-0 rounded-full transition-opacity duration-300 blur-sm ${
            isHovered ? 'opacity-100 bg-[#C9A227]/50' : 'opacity-40 bg-[#C9A227]/20'
          }`}
        />
        {/* Business Industry Visual Container */}
        <div className="w-11 h-11 rounded-full overflow-hidden border-2 border-[#C9A227]/70 shadow-xl relative z-10 bg-[#0B1426]">
          <img
            src={image3dUrl}
            alt={worldId}
